  ...
  return (
    <PageWrapper>
      <div className={`static-page ${styles.aboutContainer}`}>
        ...
        <ul>
          <li>
            <ExternalLink href="https://github.com/Commander-Spellbook/website-v2">Website Source Code on GitHub
            </ExternalLink>
          </li>
          <li>
            <ExternalLink href="https://docs.google.com/spreadsheets/d/1KqyDRZRCgy8YgMFnY0tHSw_3jC99Z0zFvJrPbfm66vA/">Combo
