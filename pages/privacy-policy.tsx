    ...
    <PageWrapper>
      <div className={`static-page ${styles.privacyPolicyContainer}`}>
        ...
        <p>
          ...
          certain rights regarding their personal information and data. The
          following section describes those rights and explains how to exercise
          them:
        </p>
        ...
        <p className="my-4">Personal information does not include:</p>
